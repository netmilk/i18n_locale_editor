...
* it autodetects if jQuery is not included in project and autoloads it from CDN as noConflict()
...
* extract to gem
* title, buttons, select options are broken
* tools for refactoring - rename path especially
