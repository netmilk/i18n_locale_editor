= Rails i18n locale editor - bleeding edge
...
* it will copy javascript asset to RAILS_ROOT/public/javascripts/i18n-locale-editor-x.x.x.js on every init, find better way 
